...
var api = function () {
    ...
    self.baseUrl = config.NorthwindServiceBaseUrl + '/Services/DataService/Northwind/ProductSet.svc';

    /**
     * <summary>
     *   Retrieve information about the entity set: "Products". 
     * </summary>
     ...
     * <returns>
     *   Entity set: <see cref="ProductSet" /> data model.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=GetSetInfo"
}
*/
     ...
     *  <see cref="Product" />) is modified or its <see cref="Product.IsEntityChanged" /> property is
     *  not set to <c>true</c>. 
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Product.CategoryRef" />, <see cref="Product.SupplierRef" /> } that an currently added or updated entity depends upon. These additional entities will be 
     ...
     *  </para>
     *  <para>
     *  Clients can also create and add to member collections in { <see cref="Product.ChangedOrder_Details" /> } entities that depends on an currently added or updated entity. These 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=AddOrUpdateEntities"
}
*/
     ...
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Product.ChangedOrder_Details" /> } that an currently added or updated entity depends upon. These additional entities will be 
     *  add or updated to the data source following the same logic, all the object relationships will be properly setup if the operation is successful.
     *  </para>
     *  <para>
     *  In general, a client can construct an object graph of any complexity following the above rules and have it added or updated to the data source in one step.
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=EnqueueNewOrUpdateEntities"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=DeleteEntities"
}
*/
    ...
    /**
     * <summary>
     *   Get a block of page frames from the entity set "Products" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   <see cref="ProductPageBlock" /> data model for entity set "Products".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=NextPageBlock"
}
*/
    ...
    /**
     * <summary>
     *   Load entities of a page from the entity set "Products" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   Collection of <see cref="Product" /> in set "Products" for the current page defined by "prevlast".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=GetPageItems"
}
*/
    ...
    /**
     * <summary>
     *   Count the number of entities inside entity set "Products" of the data source under specified filtering condition. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=QueryEntityCount"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Product" /> inside entity set "Products" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=QueryDatabase"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Product" /> inside entity set "Products" from the data source under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=QueryDatabaseLimited"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Products" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
     *   The number of entities.
     * </returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=ConstraintQueryEntityCount"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "Products" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=ConstraintsFindMatches"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Product" /> inside entity set "Products" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Products" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=ConstraintQuery"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Product" /> inside entity set "Products" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Products" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=ConstraintQueryLimited"
}
*/
    ...
    /**
     * <summary>
     *   Load the entity "CategoryRef" of type <see cref="Category" /> that the entity depend upon. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="Category" /> or null.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=MaterializeCategoryRef"
}
*/
    self.MaterializeCategoryRef = function (input) {
        var __promise = new B(function (resolve, reject) {
            var opts = {
                url: self.baseUrl + '/MaterializeCategoryRef',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeCategoryRefResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Category'] !== 'undefined') {
                        resolve(propFilters['Category'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
    ...
    /**
     * <summary>
     *   Load the entity "SupplierRef" of type <see cref="Supplier" /> that the entity depend upon. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="Supplier" /> or null.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=MaterializeSupplierRef"
}
*/
    self.MaterializeSupplierRef = function (input) {
        var __promise = new B(function (resolve, reject) {
            var opts = {
                url: self.baseUrl + '/MaterializeSupplierRef',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeSupplierRefResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Supplier'] !== 'undefined') {
                        resolve(propFilters['Supplier'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
    ...
    /**
     * <summary>
     *   Get the collection of non-trivial foreign key constrains of type <see cref="Product" /> inside entity set "Products" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     ...
     * </returns>
     * <remarks>It will throw an exception if the <see cref="ProductSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=QuerySetConstraints"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=MaterializeOrder_Details"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=MaterializeAllOrder_Details"
}
*/
    ...
    /**
     * <summary>
     *   Load the set of indirectly depending entities "Order_Detail" of type <see cref="OrderSet" /> of an entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=MaterializeOrders"
}
*/
    ...
    /**
     * <summary>
     *   Load the collection of indirectly depending entities "AllOrders" of type <see cref="IEnumerable{Order}" /> (T = <see cref="Order" />) of the entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="IEnumerable{Order}" /> (T = <see cref="Order" />).
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=MaterializeAllOrders"
}
*/
    ...
    /**
     * <summary>
     *  Load an entity from the entity set having specified primary key(s): { <see cref="Product.ProductID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_ProductID">Primary key <see cref="Product.ProductID" />.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=LoadEntityByKey"
}
*/
        ...
        var __promise = new B(function (resolve, reject) {
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    ...
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Product'] !== 'undefined') {
                        resolve(propFilters['Product'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
    ...
    /**
     * <summary>
     *  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="Product.ProductID" /> }. . It is designed to be called by clients other than .Net native ones.
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_ProductID">Primary key <see cref="Product.ProductID" />.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=LoadEntityGraphRecursJson"
}
*/
    ...
    /**
     * <summary>
     *  Load a set entities from the entity set having specified intrinsic ids: { <see cref="Product.ProductName" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_ProductName">Intrinsic id <see cref="Product.ProductName" />.</param>
     * <remarks>
     *  <para>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=LoadEntityByNature"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=GetNextSorterOps"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ProductServiceInputParams?db=Northwind&subdoc=GetNextFilterOps"
}
*/
