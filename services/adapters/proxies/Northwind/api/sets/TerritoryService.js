...
var api = function () {
    ...
    self.baseUrl = config.NorthwindServiceBaseUrl + '/Services/DataService/Northwind/TerritorySet.svc';
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeRegionRefResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Region'] !== 'undefined') {
                        resolve(propFilters['Region'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    ...
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Territory'] !== 'undefined') {
                        resolve(propFilters['Territory'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
