...
var api = function () {
    ...
    self.baseUrl = config.NorthwindServiceBaseUrl + '/Services/DataService/Northwind/OrderSet.svc';

    /**
     * <summary>
     *   Retrieve information about the entity set: "Orders". 
     * </summary>
     ...
     * <returns>
     *   Entity set: <see cref="OrderSet" /> data model.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=GetSetInfo"
}
*/
     ...
     *  <see cref="Order" />) is modified or its <see cref="Order.IsEntityChanged" /> property is
     *  not set to <c>true</c>. 
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Order.CustomerRef" />, <see cref="Order.EmployeeRef" />, <see cref="Order.ShipperRef" /> } that an currently added or updated entity depends upon. These additional entities will be 
     ...
     *  </para>
     *  <para>
     *  Clients can also create and add to member collections in { <see cref="Order.ChangedOrder_Details" /> } entities that depends on an currently added or updated entity. These 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=AddOrUpdateEntities"
}
*/
     ...
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Order.ChangedOrder_Details" /> } that an currently added or updated entity depends upon. These additional entities will be 
     *  add or updated to the data source following the same logic, all the object relationships will be properly setup if the operation is successful.
     *  </para>
     *  <para>
     *  In general, a client can construct an object graph of any complexity following the above rules and have it added or updated to the data source in one step.
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=EnqueueNewOrUpdateEntities"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=DeleteEntities"
}
*/
    ...
    /**
     * <summary>
     *   Get a block of page frames from the entity set "Orders" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   <see cref="OrderPageBlock" /> data model for entity set "Orders".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=NextPageBlock"
}
*/
    ...
    /**
     * <summary>
     *   Load entities of a page from the entity set "Orders" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   Collection of <see cref="Order" /> in set "Orders" for the current page defined by "prevlast".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=GetPageItems"
}
*/
    ...
    /**
     * <summary>
     *   Count the number of entities inside entity set "Orders" of the data source under specified filtering condition. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=QueryEntityCount"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Order" /> inside entity set "Orders" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=QueryDatabase"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Order" /> inside entity set "Orders" from the data source under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=QueryDatabaseLimited"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Orders" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
     *   The number of entities.
     * </returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=ConstraintQueryEntityCount"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "Orders" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=ConstraintsFindMatches"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Order" /> inside entity set "Orders" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Orders" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=ConstraintQuery"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Order" /> inside entity set "Orders" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Orders" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=ConstraintQueryLimited"
}
*/
    ...
    /**
     * <summary>
     *   Load the entity "CustomerRef" of type <see cref="Customer" /> that the entity depend upon. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="Customer" /> or null.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=MaterializeCustomerRef"
}
*/
    self.MaterializeCustomerRef = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeCustomerRef',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeCustomerRefResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Customer'] !== 'undefined') {
                        resolve(propFilters['Customer'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=MaterializeEmployeeRef"
}
*/
    self.MaterializeEmployeeRef = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeEmployeeRef',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeEmployeeRefResult;
                    } else {
                        data = body;
                    }
    ...
    /**
     * <summary>
     *   Load the entity "ShipperRef" of type <see cref="Shipper" /> that the entity depend upon. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="Shipper" /> or null.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=MaterializeShipperRef"
}
*/
    self.MaterializeShipperRef = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeShipperRef',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeShipperRefResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Shipper'] !== 'undefined') {
                        resolve(propFilters['Shipper'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
    ...
    /**
     * <summary>
     *   Get the collection of non-trivial foreign key constrains of type <see cref="Order" /> inside entity set "Orders" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     ...
     * </returns>
     * <remarks>It will throw an exception if the <see cref="OrderSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=QuerySetConstraints"
}
*/
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.QuerySetConstraintsResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
    ...
    /**
     * <summary>
     *   Load the set of depending entities "Order_Details" of type <see cref="Order_DetailSet" /> of the entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="Order_DetailSet" />.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=MaterializeOrder_Details"
}
*/
    self.MaterializeOrder_Details = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeOrder_Details',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeOrder_DetailsResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
    ...
    /**
     * <summary>
     *   Load the collection of depending entities "AllOrder_Details" of type <see cref="IEnumerable{Order_Detail}" /> (T = <see cref="Order_Detail" />) of the entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <returns>
     *   An collecton of type <see cref="IEnumerable{Order_Detail}" /> (T = <see cref="Order_Detail" />).
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=MaterializeAllOrder_Details"
}
*/
    self.MaterializeAllOrder_Details = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeAllOrder_Details',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeAllOrder_DetailsResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Order_Detail'] !== 'undefined') {
                        resolve(propFilters['Order_Detail'].many(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
    ...
    /**
     * <summary>
     *   Load the set of indirectly depending entities "Order_Detail" of type <see cref="ProductSet" /> of an entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=MaterializeProducts"
}
*/
    self.MaterializeProducts = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeProducts',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeProductsResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
    ...
    /**
     * <summary>
     *   Load the collection of indirectly depending entities "AllProducts" of type <see cref="IEnumerable{Product}" /> (T = <see cref="Product" />) of the entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="IEnumerable{Product}" /> (T = <see cref="Product" />).
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=MaterializeAllProducts"
}
*/
    self.MaterializeAllProducts = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeAllProducts',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeAllProductsResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Product'] !== 'undefined') {
                        resolve(propFilters['Product'].many(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
    ...
    /**
     * <summary>
     *  Load an entity from the entity set having specified primary key(s): { <see cref="Order.OrderID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_OrderID">Primary key <see cref="Order.OrderID" />.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=LoadEntityByKey"
}
*/
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    ...
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Order'] !== 'undefined') {
                        resolve(propFilters['Order'].one(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
    ...
    /**
     * <summary>
     *  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="Order.OrderID" /> }. . It is designed to be called by clients other than .Net native ones.
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_OrderID">Primary key <see cref="Order.OrderID" />.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=LoadEntityGraphRecursJson"
}
*/
    ...
    /**
     * <summary>
     *  Load a set entities from the entity set having specified intrinsic ids: { <see cref="Order.CustomerID" />, <see cref="Order.ShipVia" />, <see cref="Order.Freight" />, <see cref="Order.OrderDate" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_CustomerID">Intrinsic id <see cref="Order.CustomerID" />.</param>
    /// <param name="_ShipVia">Intrinsic id <see cref="Order.ShipVia" />.</param>
    /// <param name="_Freight">Intrinsic id <see cref="Order.Freight" />.</param>
    /// <param name="_OrderDate">Intrinsic id <see cref="Order.OrderDate" />.</param>
     * <remarks>
     *  <para>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=LoadEntityByNature"
}
*/
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                ...
                json: {
                    ...
                    _ShipVia: input._ShipVia || input.ShipVia, 
                    _Freight: input._Freight || input.Freight, 
                    _OrderDate: input._OrderDate || input.OrderDate
                }
            };
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=GetNextSorterOps"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/OrderServiceInputParams?db=Northwind&subdoc=GetNextFilterOps"
}
*/
