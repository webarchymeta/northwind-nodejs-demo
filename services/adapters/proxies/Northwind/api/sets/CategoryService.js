...
var api = function () {
    ...
    self.baseUrl = config.NorthwindServiceBaseUrl + '/Services/DataService/Northwind/CategorySet.svc';
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    ...
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Category'] !== 'undefined') {
                        resolve(propFilters['Category'].many(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
...
*/
    self.MaterializeSuppliers = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeSuppliers',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeSuppliersResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
...
*/
    self.MaterializeAllSuppliers = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/MaterializeAllSuppliers',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx), 
                    entity: input.entity
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.MaterializeAllSuppliersResult;
                    } else {
                        data = body;
                    }
                    if ((typeof opts.json.cntx.allProperties === 'undefined' || !opts.json.cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Supplier'] !== 'undefined') {
                        resolve(propFilters['Supplier'].many(data, false));
                    } else {
                        resolve(data);
                    }
                } else {
...
*/
    self.LoadEntityDescription = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/LoadEntityDescription',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx),
                    _CategoryID: input._CategoryID || input.CategoryID
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.LoadEntityDescriptionResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
...
*/
    self.UpdateEntityDescription = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/UpdateEntityDescription',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx),
                    _CategoryID: input._CategoryID || input.CategoryID,
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.UpdateEntityDescriptionResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
...
*/
    self.LoadEntityPicture = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/LoadEntityPicture',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx),
                    _CategoryID: input._CategoryID || input.CategoryID
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.LoadEntityPictureResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
...
*/
    self.UpdateEntityPicture = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                url: self.baseUrl + '/UpdateEntityPicture',
                method: 'POST',
                json: {
                    cntx: config.mapCntx(input.cntx || cntx),
                    _CategoryID: input._CategoryID || input.CategoryID,
            ...
            req(opts, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    var data; 
                    if (typeof config.inProcessDatabase.wcfBackendService === 'undefined' || config.inProcessDatabase.wcfBackendService) {
                        data = body.UpdateEntityPictureResult;
                    } else {
                        data = body;
                    }
                    resolve(data);
