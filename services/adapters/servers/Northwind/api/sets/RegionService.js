...
var api = function () {
    ...
    /**
     * <summary>
     *   Retrieve information about the entity set: "Region". 
     * </summary>
     ...
     * <returns>
     *   Entity set: <see cref="RegionSet" /> data model.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=GetSetInfo"
}
*/
     ...
     *  <see cref="Region" />) is modified or its <see cref="Region.IsEntityChanged" /> property is
     *  not set to <c>true</c>. 
     *  </para>
     *  <para>
     *  Clients can also create and add to member collections in { <see cref="Region.ChangedTerritorys" /> } entities that depends on an currently added or updated entity. These 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=AddOrUpdateEntities"
}
*/
     ...
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Region.ChangedTerritorys" /> } that an currently added or updated entity depends upon. These additional entities will be 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=EnqueueNewOrUpdateEntities"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=DeleteEntities"
}
*/
    ...
    /**
     * <summary>
     *   Get a block of page frames from the entity set "Region" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   <see cref="RegionPageBlock" /> data model for entity set "Region".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=NextPageBlock"
}
*/
    ...
    /**
     * <summary>
     *   Load entities of a page from the entity set "Region" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   Collection of <see cref="Region" /> in set "Region" for the current page defined by "prevlast".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=GetPageItems"
}
*/
            ...
            self._GetPageItems(opts, function (error, result) {
                if (!error)
                {
                    ...
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Region'] !== 'undefined')
                        resolve(propFilters['Region'].many(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
    ...
    /**
     * <summary>
     *   Count the number of entities inside entity set "Region" of the data source under specified filtering condition. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=QueryEntityCount"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Region" /> inside entity set "Region" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=QueryDatabase"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Region" /> inside entity set "Region" from the data source under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=QueryDatabaseLimited"
}
*/
    ...
    /**
     * <summary>
     *   Load the set of depending entities "Territorys" of type <see cref="TerritorySet" /> of the entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=MaterializeTerritorys"
}
*/
    self.MaterializeTerritorys = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                cntx: JSON.stringify(typeof input.cntx === 'undefined' || !input.cntx ? cntx : input.cntx),
                entity: JSON.stringify(input.entity)
            };
            self._MaterializeTerritorys(opts, function (error, result) {
                if (!error)
                    resolve(JSON.parse(result));
                else
                    reject(error);
    ...
    /**
     * <summary>
     *   Load the collection of depending entities "AllTerritorys" of type <see cref="IEnumerable{Territory}" /> (T = <see cref="Territory" />) of the entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <returns>
     *   An collecton of type <see cref="IEnumerable{Territory}" /> (T = <see cref="Territory" />).
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=MaterializeAllTerritorys"
}
*/
    self.MaterializeAllTerritorys = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                cntx: JSON.stringify(typeof input.cntx === 'undefined' || !input.cntx ? cntx : input.cntx),
                entity: JSON.stringify(input.entity)
            };
            self._MaterializeAllTerritorys(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
    ...
    /**
     * <summary>
     *  Load an entity from the entity set having specified primary key(s): { <see cref="Region.RegionID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_RegionID">Primary key <see cref="Region.RegionID" />.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=LoadEntityByKey"
}
*/
    self.LoadEntityByKey = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                cntx: JSON.stringify(typeof input.cntx === 'undefined' || !input.cntx ? cntx : input.cntx),
                _RegionID: input._RegionID || input.RegionID
            };
    ...
    /**
     * <summary>
     *  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="Region.RegionID" /> }. . It is designed to be called by clients other than .Net native ones.
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_RegionID">Primary key <see cref="Region.RegionID" />.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=LoadEntityGraphRecursJson"
}
*/
    ...
    /**
     * <summary>
     *  Load a set entities from the entity set having specified intrinsic ids: { <see cref="Region.RegionID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_RegionID">Intrinsic id <see cref="Region.RegionID" />.</param>
     * <remarks>
     *  <para>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=LoadEntityByNature"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=GetNextSorterOps"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/RegionServiceInputParams?db=Northwind&subdoc=GetNextFilterOps"
}
*/
...
api.prototype._GetSetInfo = edge.func({
    ...
    typeName: 'CryptoGateway.RDB.Data.Northwind.RegionNodeJsApi',
...
api.prototype._MaterializeTerritorys = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.RegionNodeJsApi',
    methodName: 'MaterializeTerritorys'
});

api.prototype._MaterializeAllTerritorys = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.RegionNodeJsApi',
    methodName: 'MaterializeAllTerritorys'
});
