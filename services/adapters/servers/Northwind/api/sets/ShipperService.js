...
var api = function () {
    ...
    /**
     * <summary>
     *   Retrieve information about the entity set: "Shippers". 
     * </summary>
     ...
     * <returns>
     *   Entity set: <see cref="ShipperSet" /> data model.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=GetSetInfo"
}
*/
     ...
     *  <see cref="Shipper" />) is modified or its <see cref="Shipper.IsEntityChanged" /> property is
     *  not set to <c>true</c>. 
     *  </para>
     *  <para>
     *  Clients can also create and add to member collections in { <see cref="Shipper.ChangedOrders" /> } entities that depends on an currently added or updated entity. These 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=AddOrUpdateEntities"
}
*/
     ...
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Shipper.ChangedOrders" /> } that an currently added or updated entity depends upon. These additional entities will be 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=EnqueueNewOrUpdateEntities"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=DeleteEntities"
}
*/
    ...
    /**
     * <summary>
     *   Get a block of page frames from the entity set "Shippers" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   <see cref="ShipperPageBlock" /> data model for entity set "Shippers".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=NextPageBlock"
}
*/
    ...
    /**
     * <summary>
     *   Load entities of a page from the entity set "Shippers" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   Collection of <see cref="Shipper" /> in set "Shippers" for the current page defined by "prevlast".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=GetPageItems"
}
*/
            ...
            self._GetPageItems(opts, function (error, result) {
                if (!error)
                {
                    ...
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Shipper'] !== 'undefined')
                        resolve(propFilters['Shipper'].many(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
    ...
    /**
     * <summary>
     *   Count the number of entities inside entity set "Shippers" of the data source under specified filtering condition. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=QueryEntityCount"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Shipper" /> inside entity set "Shippers" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=QueryDatabase"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Shipper" /> inside entity set "Shippers" from the data source under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=QueryDatabaseLimited"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=MaterializeOrders"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=MaterializeAllOrders"
}
*/
    ...
    /**
     * <summary>
     *  Load an entity from the entity set having specified primary key(s): { <see cref="Shipper.ShipperID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_ShipperID">Primary key <see cref="Shipper.ShipperID" />.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=LoadEntityByKey"
}
*/
    self.LoadEntityByKey = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                cntx: JSON.stringify(typeof input.cntx === 'undefined' || !input.cntx ? cntx : input.cntx),
                _ShipperID: input._ShipperID || input.ShipperID
            };
    ...
    /**
     * <summary>
     *  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="Shipper.ShipperID" /> }. . It is designed to be called by clients other than .Net native ones.
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_ShipperID">Primary key <see cref="Shipper.ShipperID" />.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=LoadEntityGraphRecursJson"
}
*/
    ...
    /**
     * <summary>
     *  Load a set entities from the entity set having specified intrinsic ids: { <see cref="Shipper.CompanyName" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_CompanyName">Intrinsic id <see cref="Shipper.CompanyName" />.</param>
     * <remarks>
     *  <para>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=LoadEntityByNature"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=GetNextSorterOps"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/ShipperServiceInputParams?db=Northwind&subdoc=GetNextFilterOps"
}
*/
...
api.prototype._GetSetInfo = edge.func({
    ...
    typeName: 'CryptoGateway.RDB.Data.Northwind.ShipperNodeJsApi',
