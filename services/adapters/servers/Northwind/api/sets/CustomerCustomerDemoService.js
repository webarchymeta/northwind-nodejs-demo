...
var api = function () {
    ...
    /**
     * <summary>
     *   Retrieve information about the entity set: "CustomerCustomerDemo". 
     * </summary>
     ...
     * <returns>
     *   Entity set: <see cref="CustomerCustomerDemoSet" /> data model.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=GetSetInfo"
}
*/
     ...
     *  <see cref="CustomerCustomerDemo" />) is modified or its <see cref="CustomerCustomerDemo.IsEntityChanged" /> property is
     *  not set to <c>true</c>. 
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="CustomerCustomerDemo.CustomerDemographicRef" />, <see cref="CustomerCustomerDemo.CustomerRef" /> } that an currently added or updated entity depends upon. These additional entities will be 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=AddOrUpdateEntities"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=EnqueueNewOrUpdateEntities"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=DeleteEntities"
}
*/
    ...
    /**
     * <summary>
     *   Get a block of page frames from the entity set "CustomerCustomerDemo" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   <see cref="CustomerCustomerDemoPageBlock" /> data model for entity set "CustomerCustomerDemo".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=NextPageBlock"
}
*/
    ...
    /**
     * <summary>
     *   Load entities of a page from the entity set "CustomerCustomerDemo" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   Collection of <see cref="CustomerCustomerDemo" /> in set "CustomerCustomerDemo" for the current page defined by "prevlast".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=GetPageItems"
}
*/
            ...
            self._GetPageItems(opts, function (error, result) {
                if (!error)
                {
                    ...
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['CustomerCustomerDemo'] !== 'undefined')
                        resolve(propFilters['CustomerCustomerDemo'].many(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
    ...
    /**
     * <summary>
     *   Count the number of entities inside entity set "CustomerCustomerDemo" of the data source under specified filtering condition. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=QueryEntityCount"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="CustomerCustomerDemo" /> inside entity set "CustomerCustomerDemo" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=QueryDatabase"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="CustomerCustomerDemo" /> inside entity set "CustomerCustomerDemo" from the data source under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=QueryDatabaseLimited"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "CustomerCustomerDemo" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
     *   The number of entities.
     * </returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=ConstraintQueryEntityCount"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "CustomerCustomerDemo" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=ConstraintsFindMatches"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="CustomerCustomerDemo" /> inside entity set "CustomerCustomerDemo" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "CustomerCustomerDemo" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=ConstraintQuery"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="CustomerCustomerDemo" /> inside entity set "CustomerCustomerDemo" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "CustomerCustomerDemo" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=ConstraintQueryLimited"
}
*/
    ...
    /**
     * <summary>
     *   Load the entity "CustomerDemographicRef" of type <see cref="CustomerDemographic" /> that the entity depend upon. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="CustomerDemographic" /> or null.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=MaterializeCustomerDemographicRef"
}
*/
    self.MaterializeCustomerDemographicRef = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                cntx: JSON.stringify(typeof input.cntx === 'undefined' || !input.cntx ? cntx : input.cntx),
                entity: JSON.stringify(input.entity)
            };
            self._MaterializeCustomerDemographicRef(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['CustomerDemographic'] !== 'undefined')
                        resolve(propFilters['CustomerDemographic'].one(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=MaterializeCustomerRef"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of non-trivial foreign key constrains of type <see cref="CustomerCustomerDemo" /> inside entity set "CustomerCustomerDemo" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     ...
     * </returns>
     * <remarks>It will throw an exception if the <see cref="CustomerCustomerDemoSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=QuerySetConstraints"
}
*/
    ...
    /**
     * <summary>
     *  Load an entity from the entity set having specified primary key(s): { <see cref="CustomerCustomerDemo.CustomerID" />, <see cref="CustomerCustomerDemo.CustomerTypeID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_CustomerID">Primary key <see cref="CustomerCustomerDemo.CustomerID" />.</param>
    /// <param name="_CustomerTypeID">Primary key <see cref="CustomerCustomerDemo.CustomerTypeID" />.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=LoadEntityByKey"
}
*/
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            self._LoadEntityByKey(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['CustomerCustomerDemo'] !== 'undefined')
                        resolve(propFilters['CustomerCustomerDemo'].one(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
    ...
    /**
     * <summary>
     *  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="CustomerCustomerDemo.CustomerID" />, <see cref="CustomerCustomerDemo.CustomerTypeID" /> }. . It is designed to be called by clients other than .Net native ones.
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_CustomerID">Primary key <see cref="CustomerCustomerDemo.CustomerID" />.</param>
    /// <param name="_CustomerTypeID">Primary key <see cref="CustomerCustomerDemo.CustomerTypeID" />.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=LoadEntityGraphRecursJson"
}
*/
    ...
    /**
     * <summary>
     *  Load a set entities from the entity set having specified intrinsic ids: { <see cref="CustomerCustomerDemo.CustomerID" />, <see cref="CustomerCustomerDemo.CustomerTypeID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_CustomerID">Intrinsic id <see cref="CustomerCustomerDemo.CustomerID" />.</param>
    /// <param name="_CustomerTypeID">Intrinsic id <see cref="CustomerCustomerDemo.CustomerTypeID" />.</param>
     * <remarks>
     *  <para>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=LoadEntityByNature"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=GetNextSorterOps"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/CustomerCustomerDemoServiceInputParams?db=Northwind&subdoc=GetNextFilterOps"
}
*/
...
api.prototype._GetSetInfo = edge.func({
    ...
    typeName: 'CryptoGateway.RDB.Data.Northwind.CustomerCustomerDemoNodeJsApi',
...
api.prototype._MaterializeCustomerDemographicRef = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.CustomerCustomerDemoNodeJsApi',
    methodName: 'MaterializeCustomerDemographicRef'
});
