...
api.prototype._GetSetInfo = edge.func({
    ...
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
...
api.prototype._MaterializeUpperRef = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'MaterializeUpperRef'
});
...
api.prototype._MaterializeTerritories = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'MaterializeTerritories'
});

api.prototype._MaterializeAllTerritories = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'MaterializeAllTerritories'
});
...
api.prototype._LoadEntitySetRoots = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'LoadEntitySetRoots'
});

api.prototype._LoadEntityParent = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'LoadEntityParent'
});

api.prototype._LoadEntityChildren = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'LoadEntityChildren'
});

api.prototype._LoadEntityFullHierarchyRecurs = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'LoadEntityFullHierarchyRecurs'
});

api.prototype._LoadEntityHierarchyRecurs = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'LoadEntityHierarchyRecurs'
});

api.prototype._LoadEntityNotes = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'LoadEntityNotes'
});

api.prototype._UpdateEntityNotes = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'UpdateEntityNotes'
});

api.prototype._LoadEntityPhoto = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'LoadEntityPhoto'
});

api.prototype._UpdateEntityPhoto = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.EmployeeNodeJsApi',
    methodName: 'UpdateEntityPhoto'
});
