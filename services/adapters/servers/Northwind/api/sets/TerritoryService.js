...
var api = function () {
    ...
    /**
     * <summary>
     *   Retrieve information about the entity set: "Territories". 
     * </summary>
     ...
     * <returns>
     *   Entity set: <see cref="TerritorySet" /> data model.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=GetSetInfo"
}
*/
     ...
     *  <see cref="Territory" />) is modified or its <see cref="Territory.IsEntityChanged" /> property is
     *  not set to <c>true</c>. 
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Territory.RegionRef" /> } that an currently added or updated entity depends upon. These additional entities will be 
     ...
     *  </para>
     *  <para>
     *  Clients can also create and add to member collections in { <see cref="Territory.ChangedEmployeeTerritorys" /> } entities that depends on an currently added or updated entity. These 
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=AddOrUpdateEntities"
}
*/
     ...
     *  </para>
     *  <para>
     *  Clients can set some of the member entities in { <see cref="Territory.ChangedEmployeeTerritorys" /> } that an currently added or updated entity depends upon. These additional entities will be 
     *  add or updated to the data source following the same logic, all the object relationships will be properly setup if the operation is successful.
     *  </para>
     *  <para>
     *  In general, a client can construct an object graph of any complexity following the above rules and have it added or updated to the data source in one step.
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=EnqueueNewOrUpdateEntities"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=DeleteEntities"
}
*/
    ...
    /**
     * <summary>
     *   Get a block of page frames from the entity set "Territories" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   <see cref="TerritoryPageBlock" /> data model for entity set "Territories".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=NextPageBlock"
}
*/
    ...
    /**
     * <summary>
     *   Load entities of a page from the entity set "Territories" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <remarks>
     ...
     * <returns>
     *   Collection of <see cref="Territory" /> in set "Territories" for the current page defined by "prevlast".
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=GetPageItems"
}
*/
    ...
    /**
     * <summary>
     *   Count the number of entities inside entity set "Territories" of the data source under specified filtering condition. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=QueryEntityCount"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Territory" /> inside entity set "Territories" of the data source under specified filtering and sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=QueryDatabase"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Territory" /> inside entity set "Territories" from the data source under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=QueryDatabaseLimited"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Territories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
     *   The number of entities.
     * </returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=ConstraintQueryEntityCount"
}
*/
     ...
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "Territories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
     * <param name="qexpr">Tokenized querying and sorting expression.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=ConstraintsFindMatches"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Territory" /> inside entity set "Territories" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Territories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=ConstraintQuery"
}
*/
    ...
    /**
     * <summary>
     *   Get the collection of entities of type <see cref="Territory" /> inside entity set "Territories" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="set">Set information.</param>
    /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "Territories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=ConstraintQueryLimited"
}
*/
    ...
    /**
     * <summary>
     *   Load the entity "RegionRef" of type <see cref="Region" /> that the entity depend upon. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="Region" /> or null.
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=MaterializeRegionRef"
}
*/
    self.MaterializeRegionRef = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            var opts = {
                cntx: JSON.stringify(typeof input.cntx === 'undefined' || !input.cntx ? cntx : input.cntx),
                entity: JSON.stringify(input.entity)
            };
            self._MaterializeRegionRef(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Region'] !== 'undefined')
                        resolve(propFilters['Region'].one(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=MaterializeEmployeeTerritorys"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=MaterializeAllEmployeeTerritorys"
}
*/
    ...
    /**
     * <summary>
     *   Load the set of indirectly depending entities "EmployeeTerritory" of type <see cref="EmployeeSet" /> of an entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=MaterializeEmployees"
}
*/
    ...
    /**
     * <summary>
     *   Load the collection of indirectly depending entities "AllEmployees" of type <see cref="IEnumerable{Employee}" /> (T = <see cref="Employee" />) of the entity. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
     * <param name="entity">The entity.</param>
     * <remarks>
     ...
     * </remarks>
     * <returns>
     *   An entity of type <see cref="IEnumerable{Employee}" /> (T = <see cref="Employee" />).
     * </returns>
     */

/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=MaterializeAllEmployees"
}
*/
    ...
    /**
     * <summary>
     *  Load an entity from the entity set having specified primary key(s): { <see cref="Territory.TerritoryID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_TerritoryID">Primary key <see cref="Territory.TerritoryID" />.</param>
     * <returns>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=LoadEntityByKey"
}
*/
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            self._LoadEntityByKey(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Territory'] !== 'undefined')
                        resolve(propFilters['Territory'].one(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
    ...
    /**
     * <summary>
     *  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="Territory.TerritoryID" /> }. . It is designed to be called by clients other than .Net native ones.
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_TerritoryID">Primary key <see cref="Territory.TerritoryID" />.</param>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=LoadEntityGraphRecursJson"
}
*/
    ...
    /**
     * <summary>
     *  Load a set entities from the entity set having specified intrinsic ids: { <see cref="Territory.TerritoryID" /> }. 
     * </summary>
     * <param name="cntx">Authenticated caller context object. If cannot be null.</param>
    /// <param name="_TerritoryID">Intrinsic id <see cref="Territory.TerritoryID" />.</param>
     * <remarks>
     *  <para>
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=LoadEntityByNature"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=GetNextSorterOps"
}
*/
...
/* input parameter schema reference template
{
    "$schema": "http://localhost:11333/sets/TerritoryServiceInputParams?db=Northwind&subdoc=GetNextFilterOps"
}
*/
...
api.prototype._GetSetInfo = edge.func({
    ...
    typeName: 'CryptoGateway.RDB.Data.Northwind.TerritoryNodeJsApi',
...
api.prototype._MaterializeRegionRef = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.TerritoryNodeJsApi',
    methodName: 'MaterializeRegionRef'
});

api.prototype._MaterializeEmployeeTerritorys = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.TerritoryNodeJsApi',
    methodName: 'MaterializeEmployeeTerritorys'
});

api.prototype._MaterializeAllEmployeeTerritorys = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.TerritoryNodeJsApi',
    methodName: 'MaterializeAllEmployeeTerritorys'
});

api.prototype._MaterializeEmployees = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.TerritoryNodeJsApi',
    methodName: 'MaterializeEmployees'
});

api.prototype._MaterializeAllEmployees = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.TerritoryNodeJsApi',
    methodName: 'MaterializeAllEmployees'
});
