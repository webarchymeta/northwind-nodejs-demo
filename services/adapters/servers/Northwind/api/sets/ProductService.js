...
*/
    self.MaterializeCategoryRef = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            self._MaterializeCategoryRef(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Category'] !== 'undefined')
                        resolve(propFilters['Category'].one(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
...
*/
    self.MaterializeSupplierRef = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            self._MaterializeSupplierRef(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
        ...
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            self._LoadEntityByKey(opts, function (error, result) {
                if (!error)
                {
                    var cntx = JSON.parse(opts.cntx);
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['Product'] !== 'undefined')
                        resolve(propFilters['Product'].one(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
...
api.prototype._GetSetInfo = edge.func({
    ...
    typeName: 'CryptoGateway.RDB.Data.Northwind.ProductNodeJsApi',
...
api.prototype._MaterializeCategoryRef = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.ProductNodeJsApi',
    methodName: 'MaterializeCategoryRef'
});

api.prototype._MaterializeSupplierRef = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.ProductNodeJsApi',
    methodName: 'MaterializeSupplierRef'
});
