            ...
            self._GetPageItems(opts, function (error, result) {
                if (!error)
                {
                    ...
                    if ((typeof cntx.allProperties === 'undefined' || !cntx.allProperties) && (config.disablePropertyFiltering === 'undefined' || !config.disablePropertyFiltering) && typeof propFilters['CustomerDemographic'] !== 'undefined')
                        resolve(propFilters['CustomerDemographic'].many(JSON.parse(result), false));
                    else
                        resolve(JSON.parse(result));
                }
                else
...
*/
    self.LoadEntityCustomerDesc = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            self._LoadEntityCustomerDesc(opts, function (error, result) {
                if (!error)
                    resolve(result);
                else
                    reject(error);
...
*/
    self.UpdateEntityCustomerDesc = function (input) {
        var __promise = new Q.Promise(function (resolve, reject, notify) {
            ...
            self._UpdateEntityCustomerDesc(opts, function (error, result) {
                if (!error)
                    resolve(JSON.parse(result));
                else
                    reject(error);
...
api.prototype._GetSetInfo = edge.func({
    ...
    typeName: 'CryptoGateway.RDB.Data.Northwind.CustomerDemographicNodeJsApi',
...
api.prototype._LoadEntityCustomerDesc = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.CustomerDemographicNodeJsApi',
    methodName: 'LoadEntityCustomerDesc'
});

api.prototype._UpdateEntityCustomerDesc = edge.func({
    assemblyFile: assemblyPath,
    typeName: 'CryptoGateway.RDB.Data.Northwind.CustomerDemographicNodeJsApi',
    methodName: 'UpdateEntityCustomerDesc'
});
