...
define(['knockout', 'config', 'queryModels' ], function (ko, config, q) {
    ...
    var RegionView = function (data) {
        var self = this;
        self.IsViewModel = true;
        self.data = data;
        self.DistinctString = data !== null ? data.DistinctString : "";
        self.LookupQuery = data !== null ? "?RegionID=" + self.data.RegionID : "";
        ...
        if (data.Territorys == null) {
            self.Territorys = ko.observable(null);
            self.IsTerritorysMaterialized = ko.observable(false);
        } else {
            self.IsTerritorysMaterialized = ko.observable(false);
            pageMgr.loadModelModule('service-clients/scripts/Northwind/models/sets/Territory', function (m) {
                self.Territorys = ko.observable(new m.entitySet(data.Territorys));
                self.IsTerritorysMaterialized(true);
            });
        }
        self.ChangedTerritorys = ko.observableArray();

        if (data !== null && data.ChangedTerritorys !== null) {
            pageMgr.loadModelModule('service-clients/scripts/Northwind/models/sets/Territory', function (m) {
                for (var i = 0; i < data.ChangedTerritorys.length; i++) {
                    self.ChangedTerritorys.push(new m.entityView(data.ChangedTerritorys[i]));
                }
                self.IsAllTerritorysMaterialized(true);
            });
        }

        self.MaterializeTerritorys = function () {
            if (self.IsTerritorysMaterialized()) {
                return $.Deferred().resolve();
            }
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/MaterializeTerritorys",
                type: "POST",
                dataType: "json",
        ...
        self.MaterializeAllTerritorys = function () {
            if (self.IsAllTerritorysMaterialized()) {
                return $.Deferred().resolve();
            }
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/MaterializeAllTerritorys",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                data: JSON.stringify({ entity: self.shallowDataCopy() })
                ...
                function (list) {
                    if (list !== null) {
                        self.data.ChangedTerritorys = list;
                        pageMgr.loadModelModule('service-clients/scripts/Northwind/models/sets/Territory', function (m) {
                            for (var i = 0; i < list.length; i++) {
                                self.ChangedTerritorys.push(new m.entityView(list[i]));
                            }
                            self.IsAllTerritorysMaterialized(true);
                        });
                    }
    ...
    var Region = function (data) {
        ...
        self.LookupQuery = data !== null ? "entityedit?RegionID=" + self.data.RegionID : "";
        ...
        self.RegionID = data.RegionID;
        self.RegionDescription = ko.observable(data !== null ? data.RegionDescription : null).extend({ required: true });
        self.IsRegionDescriptionModified = ko.observable(data !== null ? data.IsRegionDescriptionModified : true);
        self.RegionDescription.subscribe(function (val) {
             if (!self.Initializing) {
                 self.IsRegionDescriptionModified(self.data == null || self.data.RegionDescription !== val);
             }
         });
        self.RegionDescriptionCss = ko.pureComputed(function () {
            if (self.IsRegionDescriptionModified()) {
                return "modified";
            } else {
                return "original";
            }
        ...
        self.IfEntityChanged = ko.pureComputed(function () {
            return self.IsRegionDescriptionModified();
        });
        ...
        self.IsEntityComplete = function () {
            return self.RegionDescription() !== null;
        };
        ...
        self.GetUpdatedData = function () {
            ...
            if (self.IsRegionDescriptionModified()) {
                if (self.IsRegionDescriptionModified()) {
                    d.RegionDescription = self.RegionDescription();
                    d.IsRegionDescriptionModified = true;
                }
        ...
        self.GetNewData = function () {
            if (self.RegionDescription() == null) {
                throw "RegionDescription is required!";
            }    
            var d = {
                "RegionID": self.RegionID,
                "RegionDescription": self.RegionDescription(),
                "IsRegionDescriptionModified": true,
        ...
        self.NewDataCopy = function () {
            var d = {
                "RegionID": self.data.RegionID,
                "RegionDescription": self.data.RegionDescription,
                "IsRegionDescriptionModified": self.IsRegionDescriptionModified(),
        ...
        self.UpdateData = function (dsrc) {
            ...
            self.data.RegionDescription = dsrc.RegionDescription;
            self.RegionDescription(dsrc.RegionDescription);
            self.IsRegionDescriptionModified(false);
        };
        ...
        self.ResetData = function () {
            ...
            if (self.IsRegionDescriptionModified()) {
                self.RegionDescription(self.data.RegionDescription);
            }
        };
        ...
        self.IsTerritorysMaterialized = ko.observable(data == null);

        self.Territorys = ko.observable(data !== null ? data.Territorys : null);
    ...
    var RegionPageBlock = function (s, idx0, data, edit) {
        ...
        if (data.Pages) {
            for (var i = 0; i < data.Pages.length; i++ ) {
                ...
                var page = new RegionPage(s, edit);
    ...
    var RegionSettings = function (settings) {
        var self = this;
        self.data = settings || {};
        ...
        self.data.show_RegionDescription = self.data.show_RegionDescription || true;
        self.show_RegionDescription = ko.observable(self.data.show_RegionDescription);
        self.show_RegionDescription.subscribe(function (v) {
            self.data.show_RegionDescription = v;
        });
        self.data.collapse_RegionDescription = self.data.collapse_RegionDescription || false;
        self.collapse_RegionDescription = ko.observable(self.data.collapse_RegionDescription);
        self.collapse_RegionDescription.subscribe(function (v) {
            self.data.collapse_RegionDescription = v;
        });
        self.data.width_RegionDescription = self.data.width_RegionDescription || 'auto';
        self.width_RegionDescription = ko.observable(self.data.width_RegionDescription);
        self.width_RegionDescription.subscribe(function (v) {
            self.data.width_RegionDescription = v;
        });
    };
    ...
    var RegionSet = function () {
        ...
        if (typeof jsonstr == 'undefined' || jsonstr == null) {
            self.settings = new RegionSettings();
            var settings = { };
            settings.UIView = { };
            settings.UIView.RegionSet = self.settings.data;
            localStorage.setItem('Northwind', JSON.stringify(settings));
        } else {
            var settings = JSON.parse(jsonstr);
            self.settings = new RegionSettings(settings.UIView.RegionSet);
        }
        ...
        self.FilteredViewUrl = ko.pureComputed(function () {
            ...
            if (s == '') {
                ...
                if (s0 == '') {
                    return 'RegionSet?filter=' + encodeURIComponent(s);
                } else {
                    return 'RegionSet?filter=' + encodeURIComponent(s0 + ' && ( ' + s + ' )');
                }
            }
        });
        ...
        self.GetSetInfo = function (tkfilter, _filter) {
            ...
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/GetSetInfo",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
        ...
        self.GetNextSorterOps = function (tkfilter) {
            ...
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/GetNextSorterOps",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
        ...
        self.NextPageBlock = function (qexpr, last, edit) {
            ...
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/NextPageBlock",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                ...
                function (data) {
                    ...
                    if (data.Pages.length == 0) {
                        ...
                        var pb = new RegionPageBlock(self, idx0, data, edit);
        ...
        self.AddOrUpdateEntities = function (changed) {
            ...
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/AddOrUpdateEntities",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
        ...
        self.DeleteEntities = function (deleted) {
            ...
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/DeleteEntities",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
        ...
        self.LoadEntityByKey = function(RegionID, isView) {
            return $.ajax({
                url: config.baseUrl + "/services/Northwind/RegionSet/LoadEntityByKey",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                ...
                function (data) {
                    if (isView)
                        return $.Deferred().resolve(new RegionView(data));
                    else
                        return $.Deferred().resolve(new Region(data));
                },
                function (jqxhr, textStatus, error) {
                    return $.Deferred().reject(jqxhr, textStatus, error);
                }
    ...
    return {
        entityView: RegionView,
        entityEdit: Region,
        entityPage: RegionPage,
        entityPageBlock: RegionPageBlock,
