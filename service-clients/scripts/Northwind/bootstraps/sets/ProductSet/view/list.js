...
requirejs(['knockout', 'pageManager', 'listactions', 'config', 'model'], function (ko, pMgr, opType, config, model) {
    ...
    pMgr.loadedControllerTable['service-clients/scripts/Northwind/controllers/sets/ProductSet/view/list'] = opType;
    ...
    $(function () {
        ...
        op.initialize(filter).done(function (m) {
            pMgr.loadPage('ProductSet/' + config.listViewEntryPart, m, op).done(function (page) {
                pMgr.opContext = 'service-clients/scripts/Northwind/controllers/sets/ProductSet/view/list';
