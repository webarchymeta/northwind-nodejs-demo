requirejs.config({
    ...
    paths: {
        ...
        queryTerms: 'service-clients/scripts/Northwind/customize/SupplierSet/querytokens',
        ...
        listactions: 'service-clients/scripts/Northwind/controllers/sets/SupplierSet/view/list',
        actions: 'service-clients/scripts/Northwind/controllers/sets/SupplierSet/view/entity'
    }
});
...
requirejs(['knockout', 'pageManager', 'listactions', 'config', 'model'], function (ko, pMgr, opType, config, model) {
    ...
    pMgr.loadedControllerTable['service-clients/scripts/Northwind/controllers/sets/SupplierSet/view/list'] = opType;
    ...
    $(function () {
        ...
        op.initialize(filter).done(function (m) {
            pMgr.loadPage('SupplierSet/' + config.listViewEntryPart, m, op).done(function (page) {
                pMgr.opContext = 'service-clients/scripts/Northwind/controllers/sets/SupplierSet/view/list';
