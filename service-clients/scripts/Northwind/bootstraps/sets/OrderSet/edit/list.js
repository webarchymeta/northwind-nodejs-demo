requirejs.config({
    ...
    paths: {
        ...
        actions: 'service-clients/scripts/Northwind/controllers/sets/OrderSet/edit/list'
    }
});
...
requirejs(['knockout', 'pageManager', 'actions', 'queryComposer'], function (ko, pMgr, op, qc) {
    ...
    pMgr.loadedControllerTable['service-clients/scripts/Northwind/controllers/sets/OrderSet/edit/list'] = opType;
    ...
    $(function () {
        ...
        op.initialize(filter).done(function (m) {
            pMgr.loadPage(config.listEditEntryPart, m).done(function (page) {
                pMgr.opContext = 'service-clients/scripts/Northwind/controllers/sets/OrderSet/edit/list';
