requirejs.config({
    ...
    paths: {
        ...
        queryTerms: 'service-clients/scripts/Northwind/customize/TerritorySet/querytokens',
        model: 'service-clients/scripts/Northwind/models/sets/Territory',
        ...
        listactions: 'service-clients/scripts/Northwind/controllers/sets/TerritorySet/view/list',
        actions: 'service-clients/scripts/Northwind/controllers/sets/TerritorySet/view/entity'
    }
});
...
requirejs(['knockout', 'pageManager', 'actions', 'config', 'model'], function (ko, pMgr, opType, config, model) {
    ...
    pMgr.loadedControllerTable['service-clients/scripts/Northwind/controllers/sets/TerritorySet/view/entity'] = opType;
    ...
    $(function () {
        ...
        var op = new opType();
        op.initialize(TerritoryID).done(function (m) {
            pMgr.loadPage(config.entityViewEntryPart, m).done(function (page) {
                pMgr.opContext = 'service-clients/scripts/Northwind/controllers/sets/view/Territory';
